...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        $_SESSION['kategori_error'] = "Nama kategori sudah digunakan oleh kategori lain.";
    } else {
        $update_query = "UPDATE kategori SET nama_kategori = '$nama_kategori', deskripsi = '$deskripsi' WHERE id_kategori = $id_kategori";
        
        if (mysqli_query($conn, $update_query)) {
            $_SESSION['kategori_success'] = "Kategori berhasil diupdate!";
            header("Location: kategori.php");
            exit;
        } else {
            $_SESSION['kategori_error'] = "Gagal mengupdate kategori: " . mysqli_error($conn);
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Kategori - WarungKu</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-6 text-sm">
            ...
            <span class="mx-2">/</span>
            <span class="text-gray-600">Edit Kategori</span>
        </div>

        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Kategori</h1>
            <p class="text-gray-600">Edit informasi kategori "<?php echo htmlspecialchars($kategori['nama_kategori']); ?>"</p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo htmlspecialchars($kategori['deskripsi']); ?></textarea>
                    </div>
                </div>
